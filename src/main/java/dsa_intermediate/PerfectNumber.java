...
public class PerfectNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Check given number is perfect or not: " + perfectNumber.solve(4));
        System.out.println("Check given number is perfect or not: " + perfectNumber.solve(6));
    }
}
